...
async def on_message(message):
    ...
    if message.content.startswith('いい曲教えて！'):
        good = ['https://www.youtube.com/watch?v=9aJVr5tTTWk',
         'https://www.youtube.com/watch?v=arSkpLlofGQ',
          ...
          'https://www.youtube.com/watch?v=MslES96hLeo','https://www.youtube.com/watch?v=q9iozQDEO_U','https://www.youtube.com/watch?v=gsVGf1T2Hfs','https://www.youtube.com/watch?v=d6QEOFjqHcM']
        await message.channel.send( random.choice(good))

    if message.content.startswith('オススメのBGM教えて！'):
        recommendation = ['https://www.youtube.com/watch?v=VR1H9njDd9w', 'https://www.youtube.com/watch?v=n8X9_MgEdCg', 'https://www.youtube.com/watch?v=3fxq7kqyWO8','https://www.youtube.com/watch?v=B7xai5u_tnk','https://www.youtube.com/watch?v=kL8CyVqzmkc','https://www.youtube.com/watch?v=YqrxIimmiqs','https://www.youtube.com/watch?v=kzr5RQE0tZs']
        await message.channel.send( random.choice(recommendation))

    if message.content.startswith('トガちゃんの画像くれ！'):
        plese = ['https://cdn.discordapp.com/attachments/457827767707238411/486475315171033097/2ab09638ac4010d5.jpg', 'https://cdn.discordapp.com/attachments/457827767707238411/486475474583683072/18.jpg', 'https://cdn.discordapp.com/attachments/457827767707238411/486475571748929537/11.jpg','https://cdn.discordapp.com/attachments/457827767707238411/486475676682027008/2.jpg']
    ...
    if message.content.startswith('r!time'):
        ...
        await message.channel.send('今の日時は\n**{0:%Y.%m/%d %p.%H:%M:%S}**です。'.format(now))
    ...
    if message.content.startswith('r!help'):
        ...
        embed.add_field(name='**BOTのバージョン**',value='ry!version')
...
client.run('NDg1MDUzNDI5OTgzNjA4ODUz.DmrAsw.9RREwh66uBWWtFaoNmmswxvRHHE')